...
import AddAvailableDepartment from "@/components/Pages/Inventory/AddAvailableDepartment";
import AddAvailableDesignation from "@/components/Pages/Inventory/AddAvailableDesignation";

const AddAvailableDesignationPage = () => {
                ...
                items={
                    [
                        ...
                        },
                        {
                            ...
                            link: '/admin/inventory/available-designation'
                        },
                    ]
                }
            />
            <AddAvailableDesignation ></AddAvailableDesignation>
        </div>
    );
};
export default AddAvailableDesignationPage;
AddAvailableDesignationPage.getLayout = function getLayout(page) {
    return (
        <Header>
            <AdminSidebar>
                {page}
