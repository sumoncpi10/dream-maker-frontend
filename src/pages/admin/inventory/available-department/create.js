...
const AddAvailableDepartmentPage = () => {
                ...
                items={
                    [
                        ...
                        },
                        {
                            ...
                            link: '/admin/inventory/available-department'
                        },
                    ]
                }
            />
            <AddAvailableDepartment ></AddAvailableDepartment>
        </div>
    );
};
export default AddAvailableDepartmentPage;
AddAvailableDepartmentPage.getLayout = function getLayout(page) {
    return (
        <Header>
            <AdminSidebar>
                {page}
